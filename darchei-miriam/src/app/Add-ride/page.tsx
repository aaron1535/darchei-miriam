...
const add_ride: React.FC = () => {
    ...
    const [travelDetails, setTravelDetails] = useState<TravelDetails>({}as TravelDetails);
    const travelDetailsContext = {details: travelDetails , setTravelDetails}

    const myConsul = (() => {
        console.log(travelDetailsContext)
    })


    return (
        <TravelDetailsContext.Provider value={travelDetailsContext}>
